...
import { validCF } from "./reg";
 function ForgotPassword (){
    ...
    return <Box style={{margin:'4rem auto', width:'50%', }}>
            <form>
                <Stack spacing={3}>
                    <Typography variant="h5">Forgot Password</Typography>
                    <Typography variant="subtitle">
                    Type your Fiscal Code here, then click on the button, we will send you your password to your e-mail address.</Typography>
                    <TextField    
                        id="fiscalCode"
                        label="Fiscal Code" 
                        required 
