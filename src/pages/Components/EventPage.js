    ...
    return (
      ...
      >
        <Card sx={{ width: 800, height: 800,   textAlign:'center',  }}>
          <CardMedia component="img" height="400" image={locationR.state.img} alt="event photo" />
          <CardContent>
          ...
          {/*TICKET ZONE */}
          <CardContent style={{ textAlign: "center", marginTop: "20px" ,padding:'30px'}}>
            <Typography variant="body1" color="text.primary">
              <b>Price: </b>{locationR.state.prezzo}
            </Typography>
